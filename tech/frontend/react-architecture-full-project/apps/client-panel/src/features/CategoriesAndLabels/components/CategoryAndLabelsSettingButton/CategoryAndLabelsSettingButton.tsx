...
export const CategoryAndLabelsSettingButton = ({ selectedRow }: Props) => {
        ...
        <>
            ...
            >
                ...
                <MenuItem onKeyDown={(e) => e.stopPropagation()} sx={MenuItemStyles(true)}>
                    <EditCategoryButton selectedRow={selectedRow} handleMenuClose={handleClose} />
                </MenuItem>
                <MenuItem onKeyDown={(e) => e.stopPropagation()} sx={MenuItemStyles(true)}>
                    <RemoveCategoryButton selectedRow={selectedRow} handleMenuClose={handleClose} />
                </MenuItem>
            </Menu>
        </>
    );

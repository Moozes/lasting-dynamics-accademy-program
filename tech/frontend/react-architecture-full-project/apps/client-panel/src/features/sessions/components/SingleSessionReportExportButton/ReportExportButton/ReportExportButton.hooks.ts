...
import { useDownloadSessionExcelStatsMutation } from "@features/sessions/queries";
...
const createAndDownloadFile = (response: AxiosResponse, fileName: string) => {
    ...
    const filename = decodeContentDisposition(contentDisposition) || `${fileName}.xlsx`;

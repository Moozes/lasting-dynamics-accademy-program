...
import { IMECAccordionProps } from "@features/MEC/types";

type Props = HTMLDivProps & IMECAccordionProps;

export const MECAccordion = ({ title, status, children, ...props }: Props) => {
